...
namespace Blazorise.Bootstrap
{
    public class BootstrapClassProvider : IClassProvider
    {
        ...
        public virtual string ButtonColor( Variant variant ) => $"{Button()}-{Variant( variant )}";

        public virtual string ButtonOutline( Variant variant ) => variant != Blazorise.Variant.None ? $"{Button()}-outline-{Variant( variant )}" : $"{Button()}-outline";
        ...
        public virtual string DropdownToggleColor( Variant variant ) => $"{Button()}-{Variant( variant )}";

        public virtual string DropdownToggleOutline( Variant variant ) => variant != Blazorise.Variant.None ? $"{Button()}-outline-{Variant( variant )}" : $"{Button()}-outline";
        ...
        public virtual string AlertColor( Variant variant ) => $"{Alert()}-{Variant( variant )}";
        ...
        public virtual string TableRowColor( Variant variant ) => $"table-{Variant( variant )}";
        ...
        public virtual string TableRowCellColor( Variant variant ) => $"table-{Variant( variant )}";
